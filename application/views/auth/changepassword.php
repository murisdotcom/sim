            ...
            <div class="col-md-3">
                <div style="border-left: medium solid #031a40;padding-left: 10px;">
                    <div id="login" class="tab-pane fade in active">
                        ...
                        <h4 class="header-content" style="text-align: center;">Change your password</h4>
                        <h5 class="mb-4" style="text-align: center;"><?= $this->session->userdata('reset_email'); ?></h5>

                        <form class="user" method="post" action="<?= base_url('auth/changepassword'); ?>" accept-charset="UTF-8">
                            ...
                            <div class="form-group" style="position: relative;">
                                <button type="submit" class="btn btn-success center-block" style="width: 55%;"><span>Change Password</span></button>
                            </div>
                        </form>
